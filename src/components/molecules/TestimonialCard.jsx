...
export default function TestimonialCard({
    ...
    return (
        <div className="flex w-80 flex-col items-start gap-2 rounded-xl bg-pure-white px-7 py-5 lg:w-96">
            <p className="font-body text-xs font-light italic text-subtitle">
                {testimonial}
            </p>
            <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col items-start">
                    <h4 className="font-body text-base font-medium text-title">
                        {authorName}
                    </h4>
                    <span className="font-sans text-xs text-paragraph">
                        {authorPosition}
                    </span>
                </div>
            </div>
