...
export default function VideoSection() {
    return (
        <div className="my-10 flex flex-col items-center gap-10 bg-pure-white p-6 md:p-10 lg:px-12 xl:px-32">
            <h4 className="text-center font-body text-base font-medium text-title md:text-left lg:text-2xl">
                {video.title}
            </h4>
